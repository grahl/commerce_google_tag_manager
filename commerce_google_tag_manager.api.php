...
/**
 * Allow altering the product data of a order line-item.
 *
...
/**
 * Allow altering the order data of a order line-item.
 *
 * The $context variable is an associative array with the following keys:
...
/**
 * Allow altering data for a single event before aggregation.
 *
...
/**
 * Allow altering aggregated event-data just before pushing to the DataLayer.
 *
